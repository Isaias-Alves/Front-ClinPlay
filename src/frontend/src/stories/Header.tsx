...
interface HeaderProps {
  ...
  tipoUsuario?: "paciente" | "profissional" | null; // Garante a propriedade na interface
  onSelectClinica: (id: string) => void;
  onNovaClinica: () => void;
  onCriarClinica?: () => void; // Garante a propriedade na interface
  usuarioLogado?: {
    nome?: string;
    avatarUrl?: string;
  };
...
const Header = ({
  ...
  tipoUsuario, // Desestruturado aqui
  onSelectClinica,
  onNovaClinica,
  onCriarClinica, // Desestruturado aqui
  usuarioLogado = {},
  onNavigatePerfil,
          ...
          {isClinicaMenuOpen && (
            ...
            >
              ...
              <div className="p-3 bg-slate-50/50 border-t border-slate-100 flex flex-col gap-2">
                ...
                {/* VALIDAÇÃO ATIVA: Se for profissional, o botão DEVE renderizar aqui */}
